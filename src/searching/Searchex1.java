...
public class Searchex1 {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(s+ " found at " + loc1 + " using Linear.");
        System.out.println(s+ " found at " + loc2 + " using Binary.");
    ...
    public static int searchLinear(String d[], String searchItem){
        ...
        for (int i = 0; i < d.length; i++) {
            ...
            if(d[i].compareTo(searchItem)==0){
                System.out.println("I compared Linear " + counter + " times");
                return i;
            }
        }
        System.out.println("I compared Linear " + counter + " times");
    ...
    public static int searchBinary (Object[] a, Object searchValue){
	   ...
	   while (left <= right){
	      ...
	      if (result == 0){
                  System.out.println("I compared Binary " + counter + " times");
	         return midpoint;
              }
	      else if (result < 0)
	         left = midpoint + 1;
